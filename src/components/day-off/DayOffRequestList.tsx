...
export function DayOffRequestList() {
  ...
  const { getRequestsByUserId, isLoading: dataLoading } = useData();
  ...
  if (!user) {
    return <p className="text-center text-muted-foreground">Please log in to view your requests.</p>;
  }
  ...
  if (userRequests.length === 0) {
    return (
      <div className="text-center py-12">
        <Image 
          src="https://picsum.photos/seed/no-requests/300/200"
          alt="No requests" 
          width={300} 
          height={200} 
